...
export default function Footer() {
  ...
  return (
    ...
    >
      {/* Cultural accent bar */}
      <div style={{ height: "4px", background: "oklch(var(--saffron))" }} />
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          {/* Nav */}
          <div>
            <p className="font-display font-bold uppercase tracking-widest text-xs mb-4 opacity-60">
              Navigate
            </p>
            ...
            <div className="flex gap-3">
              {socialLinks.map(({ icon: Icon, label, href }) => (
                <a
                  ...
                  style={{ backgroundColor: "oklch(var(--offwhite) / 0.1)" }}
                >
                  <Icon size={18} style={{ color: "oklch(var(--offwhite))" }} />
                </a>
              ))}
            </div>
          </div>
        ...
        <div
          ...
          style={{ borderTop: "1px solid oklch(var(--offwhite) / 0.15)" }}
        >
