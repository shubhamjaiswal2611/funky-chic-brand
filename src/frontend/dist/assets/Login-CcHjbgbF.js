import { e as useAuth, E as useNavigate, a as useThemeStore, r as reactExports, j as jsxRuntimeExports, m as motion, Z as Zap, G as Label, I as Input, B as Button, L as Link } from "./index-DSz6-5OR.js";
import { E as EyeOff, a as Eye } from "./eye-d-8w5iBr.js";
function MandalaDecor({ isSignal }) {
  const color = isSignal ? "oklch(0.88 0.3 130 / 0.18)" : "oklch(0.76 0.18 72 / 0.12)";
...
function Login() {
  ...
  const secondaryColor = isSignal ? "oklch(var(--lime))" : "oklch(var(--secondary))";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(MandalaDecor, { isSignal }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h1",
                {
                  ...
                  children: isSignal ? "COME IN, REBEL." : "WELCOME BACK"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "p",
                {
                  ...
                  children: [
                    "Sign in to access your wishlist, track orders, and unlock the full AltInstinct experience.",
                    " ",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    ...
                    style: {
                      ...
                      boxShadow: isSignal ? "0 0 24px oklch(0.6 0.32 330 / 0.5)" : "none"
                    },
                    children: isInitializing ? "Loading…" : isLoggingIn ? "Signing in…" : isSignal ? "LET ME IN →" : "Sign In"
                  }
                )
              ] }),
