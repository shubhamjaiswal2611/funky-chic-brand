import { f as useCartStore, a as useThemeStore, E as useNavigate, j as jsxRuntimeExports, S as ShoppingBag, m as motion, L as Link, B as Button, A as AnimatePresence } from "./index-DSz6-5OR.js";
import { S as Separator } from "./separator-CRq-QQNj.js";
...
function Cart() {
  ...
  const accentColor = isSignal ? "oklch(var(--lime))" : "oklch(var(--indigo, 0.48 0.2 273))";
  const priceColor = isSignal ? "oklch(var(--secondary))" : "oklch(var(--primary))";
  const ctaBg = isSignal ? "oklch(var(--hotpink))" : "oklch(var(--primary))";
  const ctaFg = isSignal ? "oklch(0.98 0 0)" : "oklch(var(--primary-foreground))";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(MotifAccent, { isSignal })
            ]
          }
        ),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    style: {
                      ...
                      border: isSignal ? "2px solid oklch(var(--hotpink) / 0.3)" : "1px solid oklch(var(--border))"
                    },
