import { c as createLucideIcon, u as useBackend, r as reactExports, a as useThemeStore, b as useQuery, j as jsxRuntimeExports, m as motion, I as Input, A as AnimatePresence, L as Link } from "./index-vtaZNhFN.js";
import { S as Skeleton } from "./skeleton-CpEEvU_U.js";
import { P as ProductCard } from "./ProductCard-DkQ5i3QS.js";
...
const PLACEHOLDER_PRODUCTS = [
  {
    ...
    category: "Apparel",
    price: BigInt(12800),
    description: "Oversized cut adorned with ukiyo-e wave motifs and graffiti kanji — where Harajuku meets Brooklyn.",
    imageUrl: "",
  ...
  },
  {
    ...
    category: "Apparel",
    price: BigInt(9500),
    description: "Hand-block-printed cotton kurta in bold Mughal floral geometry — tailored for the streets.",
    imageUrl: "",
  ...
  },
  {
    ...
    category: "Apparel",
    price: BigInt(16500),
    description: "Woven Kente-stripe panels meet raw indigo denim — a cross-continent fusion born from West African looms.",
    imageUrl: "",
  ...
  },
  {
    ...
    category: "Apparel",
    price: BigInt(7200),
    description: "Organic cotton heavyweight tee with hand-embroidered Zapotec floral borders — artisan craft meets everyday wear.",
    imageUrl: "",
  ...
  },
  {
    ...
    price: BigInt(3800),
    description: "100% silk scarf featuring shibori indigo-dye patterns inspired by Kyoto artisan dyehouses.",
    imageUrl: "",
  ...
  },
  {
    ...
    category: "Accessories",
    price: BigInt(5500),
    description: "Recycled brass bracelet engraved with an 8-pointed mandala drawn from Rajasthani temple architecture.",
    imageUrl: "",
  ...
  },
  {
    ...
    category: "Accessories",
    price: BigInt(4800),
    description: "6-panel structured cap combining hand-painted graffiti lettering with authentic Ghanaian Kente-inspired trim.",
    imageUrl: "",
  ...
  },
  {
    ...
    category: "Accessories",
    price: BigInt(6200),
    description: "Wax-resist batik canvas tote in Javanese parang patterns — holds your world, tells its stories.",
    imageUrl: "",
  ...
  },
  {
    ...
    category: "Lifestyle",
    price: BigInt(4200),
    description: "Curated incense from Jaipur oud makers and Oaxacan copal harvesters — ritual meets slow living.",
    imageUrl: "",
  ...
  },
  {
    ...
    category: "Lifestyle",
    price: BigInt(5800),
    description: "Soy wax candle in hand-thrown terracotta vessel, scented with rose, vetiver and oud.",
    imageUrl: "",
    stockQuantity: BigInt(20),
    variants: []
  },
  {
    ...
    category: "Fusion Art",
    price: BigInt(8900),
    description: "Limited giclée print marrying Hokusai wave energy with Rajasthani miniature pigment work — numbered edition of 100.",
    imageUrl: "",
  ...
  },
  {
    ...
    category: "Fusion Art",
    price: BigInt(1800),
    description: "12 die-cut vinyl stickers fusing West African griot symbols with Tokyo street-art tag aesthetics.",
    imageUrl: "",
...
function Products() {
  ...
  const filtered = products.filter((p) => activeCategory === "All" || p.category === activeCategory).filter(
    ...
    "div",
    {
      ...
      children: [
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                MandalaDecor,
                {
                  ...
                  style: {
                    color: isFunky ? "oklch(var(--lime) / 0.15)" : "oklch(var(--primary) / 0.06)"
                  }
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                MandalaDecor,
                {
                  ...
                  style: {
                    color: isFunky ? "oklch(var(--hotpink) / 0.12)" : "oklch(var(--secondary) / 0.08)"
                  }
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                BlockPrintDecor,
                {
                  ...
                  style: {
                    color: isFunky ? "oklch(var(--neonblue) / 0.25)" : "oklch(var(--secondary) / 0.12)"
                  }
                }
              ),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 container mx-auto px-4 text-center", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  motion.p,
                  {
                    ...
                    children: "Global Culture · Streetwear Energy"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  motion.h1,
                  {
                    ...
                    children: isFunky ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                      "SHOP",
                      " ",
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  motion.p,
                  {
                    ...
                    children: isFunky ? "No rules. No borders. Pure culture — pick your vibe." : "A considered collection where global craft meets timeless style."
                  }
                )
              ] }),
              !isFunky && /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: `sticky top-0 z-20 backdrop-blur-sm transition-theme ${isFunky ? "border-b border-border/40" : "border-b border-border bg-background/95"}`,
            style: isFunky ? { backgroundColor: "oklch(var(--background) / 0.94)" } : {},
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Input,
                  {
                    ...
                    style: {
                      ...
                      borderColor: isFunky ? searchQuery ? "oklch(var(--lime))" : "oklch(var(--border))" : "oklch(var(--border))"
                    }
                  }
                ),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "container mx-auto px-4 py-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.p,
            {
              ...
              style: { color: "oklch(var(--muted-foreground))" },
              children: isLoading || actorFetching ? "Loading..." : `${filtered.length} ${filtered.length === 1 ? "item" : "items"}${activeCategory !== "All" ? ` · ${activeCategory}` : ""}${searchQuery ? ` matching "${searchQuery}"` : ""}`
            },
          ...
          )) }) : filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              initial: { opacity: 0, y: 20 },
              animate: { opacity: 1, y: 0 },
          ...
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                children: isFunky ? "⚡ WEAR THE WORLD — FIVE CULTURES · ZERO LIMITS ⚡" : "Wear the world — crafted with care, worn with intention"
              }
            ) })
          }
        )
