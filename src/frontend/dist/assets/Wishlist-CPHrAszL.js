import { e as useAuth, j as jsxRuntimeExports, N as Navigate, g as useWishlistStore, f as useCartStore, a as useThemeStore, H as Heart, m as motion, L as Link, B as Button, A as AnimatePresence, S as ShoppingBag, i as ue } from "./index-DSz6-5OR.js";
...
function BlockPrintHeader({ isSignal }) {
  const c1 = isSignal ? "oklch(0.88 0.3 130 / 0.25)" : "oklch(0.76 0.18 72 / 0.18)";
  const c2 = isSignal ? "oklch(0.6 0.32 330 / 0.2)" : "oklch(0.48 0.2 273 / 0.12)";
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-[4/5] bg-muted overflow-hidden", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                backgroundColor: isSignal ? "oklch(0.88 0.3 130 / 0.2)" : "oklch(var(--secondary) / 0.15)",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                ...
                style: {
                  ...
                  color: isSignal ? "oklch(0.98 0 0)" : "oklch(var(--primary-foreground))",
                  boxShadow: isSignal ? "0 0 16px oklch(0.6 0.32 330 / 0.35)" : "none"
                },
                children: [
...
function WishlistContent() {
  ...
  const accentColor = isSignal ? "oklch(var(--hotpink))" : "oklch(var(--primary))";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "wishlist.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(BlockPrintHeader, { isSignal }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h1",
                {
                  ...
                  style: { color: "oklch(var(--foreground))" },
                  children: isSignal ? "YOUR FIRE LIST" : "YOUR WISHLIST"
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h2",
                {
                  ...
                  style: { color: "oklch(var(--foreground))" },
                  children: isSignal ? "NOTHING HERE YET." : "Your Wishlist is Empty"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  style: { color: "oklch(var(--muted-foreground))" },
                  children: isSignal ? "Find something loud, bold, and undeniably you." : "Discover pieces that speak to your style and save them here."
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/products", "data-ocid": "wishlist.go_shopping_link", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                style: {
                  ...
                  color: isSignal ? "oklch(0.98 0 0)" : "oklch(var(--primary-foreground))",
                  boxShadow: isSignal ? "0 0 24px oklch(0.6 0.32 330 / 0.4)" : "none"
                },
                children: isSignal ? "SHOP THE DROP →" : "Browse Collection"
              }
            ) })
          ]
        }
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/products", "data-ocid": "wishlist.discover_more_link", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              style: {
                backgroundColor: accentColor,
                color: isSignal ? "oklch(0.98 0 0)" : "oklch(var(--primary-foreground))",
                boxShadow: isSignal ? "0 0 28px oklch(0.6 0.32 330 / 0.35)" : "none"
              },
              children: isSignal ? "DISCOVER MORE →" : "Discover More Pieces"
            }
          ) })
        }
      )
