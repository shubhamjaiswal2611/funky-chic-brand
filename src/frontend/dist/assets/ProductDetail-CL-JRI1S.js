import { d as useParams, u as useBackend, a as useThemeStore, e as useAuth, f as useCartStore, g as useWishlistStore, r as reactExports, b as useQuery, j as jsxRuntimeExports, L as Link, B as Button, m as motion, P as ProductMockup, h as Badge, H as Heart, i as ue } from "./index-DSz6-5OR.js";
import { S as Skeleton } from "./skeleton-D2mlPOd_.js";
import { T as TooltipProvider, a as Tooltip, b as TooltipTrigger, c as TooltipContent, P as ProductCard } from "./ProductCard-CsJlFOMk.js";
import { A as ArrowLeft } from "./arrow-left-BP0GkHGw.js";
import { M as Minus } from "./minus-DWvApncj.js";
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 py-8", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-10 lg:gap-16", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              className: "relative",
              children: [
                isSignal && inStock && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative rounded-xl overflow-hidden aspect-square bg-muted", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    ProductMockup,
                    {
                      ...
                      category: product.category,
                      emotion: product.emotion ?? void 0,
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      ...
                      style: {
                        color: isSignal ? "oklch(var(--secondary))" : "oklch(var(--primary))",
                        textShadow: isSignal ? "0 0 20px oklch(var(--secondary) / 0.4)" : "none"
                      },
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    className: "h-px",
                    style: {
                      background: isSignal ? "linear-gradient(90deg, oklch(var(--hotpink)), oklch(var(--neonblue)), transparent)" : "oklch(var(--border))"
                    }
                  }
                ),
                      ...
                      children: sizes.map((size) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
                          ...
                          style: selectedSize === size ? {
                            backgroundColor: isSignal ? "oklch(var(--hotpink))" : "oklch(var(--primary))",
                            color: "oklch(var(--primary-foreground))",
                            borderColor: isSignal ? "oklch(var(--hotpink))" : "oklch(var(--primary))",
                            boxShadow: isSignal ? "2px 2px 0 oklch(var(--lime))" : "none"
                          } : {
                      ...
                      children: colors.map((color) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
                          ...
                          style: selectedColor === color ? {
                            backgroundColor: isSignal ? "oklch(var(--neonblue))" : "oklch(var(--primary))",
                            color: "oklch(var(--primary-foreground))",
                            borderColor: isSignal ? "oklch(var(--neonblue))" : "oklch(var(--primary))",
                            boxShadow: isSignal ? "2px 2px 0 oklch(var(--hotpink))" : "none"
                          } : {
                            backgroundColor: "transparent",
                            borderColor: "oklch(var(--border))",
                            color: "oklch(var(--foreground))"
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Button,
                    {
                      ...
                      style: inStock ? {
                        backgroundColor: isSignal ? "oklch(var(--hotpink))" : "oklch(var(--primary))",
                        color: "oklch(var(--primary-foreground))",
                        boxShadow: isSignal ? "4px 4px 0 oklch(var(--lime))" : "none"
                      } : {},
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Button,
                      {
                        ...
                        style: {
                          ...
                          boxShadow: isSignal && wishlisted ? "2px 2px 0 oklch(var(--hotpink))" : "none"
                        },
                        children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                          Heart,
                          {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mb-8 flex items-center gap-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "h2",
              {
                ...
                style: {
                  color: isSignal ? "oklch(var(--lime))" : "oklch(var(--foreground))",
                  textShadow: isSignal ? "0 0 20px oklch(var(--lime) / 0.4)" : "none"
                },
                children: isSignal ? "⚡ YOU MIGHT ALSO WANT ⚡" : "You May Also Like"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            style: {
              backgroundColor: isSignal ? "oklch(var(--card))" : "oklch(var(--muted) / 0.4)",
              border: isSignal ? "2px solid oklch(var(--hotpink) / 0.4)" : "1px solid oklch(var(--border))"
            },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                PaisleyDecor,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                PaisleyDecor,
                {
                  ...
                  style: {
                    color: isSignal ? "oklch(var(--hotpink))" : "oklch(var(--primary))"
                  }
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  style: {
                    color: isSignal ? "oklch(var(--neonblue))" : "oklch(var(--muted-foreground))"
                  },
                  children: isSignal ? "⚡ HANDCRAFTED · GLOBALLY SOURCED · STREET CERTIFIED ⚡" : "Handcrafted · Globally Sourced · Ethically Made"
                }
              )
            ]
          }
