import { c as createLucideIcon, r as reactExports, n as useControllableState, j as jsxRuntimeExports, l as useId, s as Presence, k as Primitive, q as composeEventHandlers, t as Portal$1, o as useComposedRefs, M as hideOthers, O as createContext2, x as createContextScope, Q as ReactRemoveScroll, T as useFocusGuards, U as FocusScope, D as DismissableLayer, V as createSlot, y as createSlottable, z as cn, W as buttonVariants, Y as useDirection, _ as Root$1, $ as Item, a0 as createRovingFocusGroupScope, e as useAuth, N as Navigate, I as Input, B as Button, i as ue, a1 as OrderStatus, X, G as Label, h as Badge, u as useBackend, a2 as useQueryClient, a as useThemeStore, b as useQuery, a3 as Settings, S as ShoppingBag, a4 as setLoreDrop, a5 as getLoreDrop } from "./index-DSz6-5OR.js";
import { C as Check, u as useMutation } from "./check-gzUi4q5u.js";
import { R as RefreshCw, C as Clock } from "./refresh-cw-D0WcKYB0.js";
import { S as Skeleton } from "./skeleton-D2mlPOd_.js";
import { P as Plus } from "./plus-B99o6rWx.js";
import { T as Trash2 } from "./trash-2-dW00TYyy.js";
import { P as Package } from "./package-DBSTd1aY.js";
/**
...
function AdminContent() {
  ...
  const [dropDate, setDropDate] = reactExports.useState("");
  const [dropTitle, setDropTitle] = reactExports.useState("");
  const [_currentDrop, _setCurrentDrop] = reactExports.useState(null);
  ...
  const loreDropMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      ue.success("Lore drop saved!");
    },
    onError: () => ue.error("Failed to save lore drop")
  });
  const openAddDialog = () => {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 py-8", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "products", "data-ocid": "admin.tabs", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "lore", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-6", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "h2",
                      {
                        ...
                        style: {
                          color: isFunky ? "oklch(var(--lime))" : "oklch(var(--foreground))",
                          textShadow: isFunky ? "0 0 12px oklch(var(--lime) / 0.4)" : "none"
                        },
                        children: "Lore Drop Schedule"
                      }
                    )
                  ] }),
                  loreDropLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      className: "font-body text-sm",
                      style: { color: "oklch(var(--muted-foreground))" },
                      children: "Loading current drop…"
                    }
                  ) : loreDropData ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      className: "mb-6 p-4 rounded-lg",
                      style: {
                        backgroundColor: isFunky ? "oklch(var(--lime) / 0.08)" : "oklch(var(--primary) / 0.06)",
                        border: isFunky ? "1px solid oklch(var(--lime) / 0.25)" : "1px solid oklch(var(--primary) / 0.2)"
                      },
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "p",
                          {
                            ...
                            style: { color: "oklch(var(--muted-foreground))" },
                            children: "Current Countdown Target"
                          }
                        ),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "p",
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "p",
                          {
                            ...
                            style: { color: "oklch(var(--muted-foreground))" },
                            children: formatLoreDropDate(loreDropData.targetTimestamp)
                          }
                        )
                      ]
                    }
                    ...
                    "div",
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "p",
                        {
                          className: "font-body text-sm",
                          style: { color: "oklch(var(--muted-foreground))" },
                          children: "No lore drop scheduled yet."
                        }
                      )
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSaveLoreDrop, className: "space-y-5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "label",
                        {
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "input",
                        {
                          ...
                          style: {
                            ...
                            color: "oklch(var(--foreground))",
                            border: isFunky ? "1px solid oklch(var(--border) / 0.6)" : "1px solid oklch(var(--border))"
                          }
                        }
                      )
                    ] }),
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
                        ...
                        style: {
                          backgroundColor: isFunky ? "oklch(var(--lime))" : "oklch(var(--primary))",
                          color: isFunky ? "oklch(var(--nearblack))" : "oklch(var(--primary-foreground))",
                          boxShadow: isFunky ? "0 0 16px oklch(var(--lime) / 0.4)" : "none"
                        },
                        children: loreDropMutation.isPending ? "Saving…" : "Save Drop Date"
                      }
                    )
                  ] })
                ]
