import { r as reactExports, j as jsxRuntimeExports, k as Primitive, l as useId, n as useControllableState, R as Root2, o as useComposedRefs, p as Anchor, q as composeEventHandlers, s as Presence, t as Portal$1, v as Arrow, w as createPopperScope, D as DismissableLayer, C as Content, x as createContextScope, y as createSlottable, z as cn, e as useAuth, f as useCartStore, g as useWishlistStore, a as useThemeStore, P as ProductMockup, H as Heart, h as Badge, B as Button, i as ue } from "./index-DSz6-5OR.js";
...
function ProductCard({ product, index = 0 }) {
  ...
  const handleAddToCart = () => {
    ...
    addToCart({
      ...
      variantSize: (_a = product.variants[0]) == null ? void 0 : _a.size,
      variantColor: (_b = product.variants[0]) == null ? void 0 : _b.color
    });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "article",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative overflow-hidden aspect-[4/5] bg-muted", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 collection-card-overlay opacity-0 group-hover:opacity-100 transition-smooth" }),
          Number(product.stockQuantity) === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-2 right-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Tooltip, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                "aria-label": !isAuthenticated ? "Login to save to wishlist" : wishlisted ? "Remove from wishlist" : "Add to wishlist",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col flex-1 p-4 gap-3", children: [
          ...
          emotion && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              style: Number(product.stockQuantity) > 0 ? {
                backgroundColor: isFunky ? "oklch(var(--accent))" : "oklch(var(--primary))",
                color: isFunky ? "oklch(var(--accent-foreground))" : "oklch(var(--primary-foreground))"
              } : {},
              children: Number(product.stockQuantity) === 0 ? "Out of Stock" : "Add to Cart"
            }
          )
        ] })
      ]
